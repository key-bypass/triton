    ...
    public List<StepBean> generateKeyCutSteps(List<List<KeyPoint>> list, List<List<KeyPoint>> list2, boolean z) {
        ...
        while (i8 < size) {
            ...
            while (i9 < list7.size()) {
                ...
                sb.append(i12);
                sb.append(str2);
                arrayList.add(StepBeanFactory.getCutStepBean(sb.toString(), i10, i11, cutZ, Speed.get_Speed_CuttingIn(), "C:5,X;C:5,Y;C:5,Z;CUTSM;"));
                if (i5 == list5.size() - 1) {
                    if (cutOnSingleKeyClamp()) {
    ...
    */
    protected int[] splitCut(int r11) {
        ...
        L16:
            ...
            r5 = 2
            if (r0 != r5) goto L24
            float[] r6 = com.liying.core.operation.cut.cutpath.blankCutPath.DoubleSideKeyCutPath.twiceCut
            r6 = r6[r3]
        L1f:
            float r6 = r6 * r2
        L21:
        ...
        L24:
            r6 = 3
            if (r0 != r6) goto L2c
            float[] r6 = com.liying.core.operation.cut.cutpath.blankCutPath.DoubleSideKeyCutPath.thriceCut
            r6 = r6[r3]
            goto L1f
        L2c:
            int r6 = r0 + (-1)
        ...
        L63:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.liying.core.operation.cut.cutpath.blankCutPath.DoubleSideKeyCutPath.splitCut(int):int[]");
    }
