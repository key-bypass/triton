...
import com.liying.core.clamp.C1976S5;
import com.liying.core.clamp.C1979S8;
...
import com.liying.core.clamp.E9S1A;
import com.liying.core.clamp.E9S1C;
import com.liying.core.clamp.E9S2A;
import com.liying.core.clamp.E9S2B;
import com.liying.core.clamp.E9S5;
import com.liying.core.clamp.S1A;
import com.liying.core.clamp.S1B;
import com.liying.core.clamp.S1C;
import com.liying.core.clamp.S1D;
import com.liying.core.clamp.S2A;
import com.liying.core.clamp.S2B;
...
public class Calibration implements Operation {
    ...
    /* renamed from: com.liying.core.operation.calibrate.Calibration$1 */
    /* loaded from: classes2.dex */
    ...
    public void saveCalibrationData(List<SerialResBean> list) {
        ...
        switch (C19901.$SwitchMap$com$liying$core$clamp$Clamp[this.calibrationParams.getClamp().ordinal()]) {
            ...
            case 10:
                ...
                return;
            case 11:
                ClampManager.getInstance().setS5(new C1976S5(list));
                return;
            case 12:
                ClampManager.getInstance().setE9S5(new E9S5(list));
                return;
            case 13:
                ClampManager.getInstance().setS8(new C1979S8(list));
                return;
            default:
                return;
        }
