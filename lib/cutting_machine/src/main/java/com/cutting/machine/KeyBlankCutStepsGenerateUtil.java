...
public class KeyBlankCutStepsGenerateUtil {
        ...
        while (i13 < spaceList.size()) {
            ...
            while (i14 < list9.size()) {
                ...
                if (z && keyInfo.getCutDepth() == 0 && i14 < toothCodeArray.get(i13).size() - 1) {
                    ...
                    double sin2 = (Math.sin(Math.toRadians(40.0d) + Math.abs(Math.atan((d3 * 1.0d) / d2))) * Math.sqrt(Math.pow(d2, 2.0d) + Math.pow(d3, 2.0d))) / Math.sin(Math.toRadians(100.0d));
                    int i15 = i8;
                    if (i15 < depthByCode5) {
                        if (align == 0) {
                            i5 = i7;
    ...
    */
    private static java.util.List<java.util.List<com.liying.core.bean.DestPoint>> getSingleOutsideGrooveKeyPoint(com.liying.core.bean.KeyInfo r23, com.liying.core.KeyAlignInfo r24, java.lang.String r25) {
        /*
            Method dump skipped, instructions count: 941
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.liying.core.KeyBlankCutStepsGenerateUtil.getSingleOutsideGrooveKeyPoint(com.liying.core.bean.KeyInfo, com.liying.core.KeyAlignInfo, java.lang.String):java.util.List");
    }
    ...
    private static List<List<DestPoint>> getSingleInsideGrooveKeyPoint(KeyInfo keyInfo, KeyAlignInfo keyAlignInfo, String str) {
        ...
        while (i5 < arrayList4.size()) {
            ...
            while (i6 < arrayList4.get(i5).size()) {
                ...
                if (i6 == arrayList4.get(i5).size() - r5) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static java.util.List<java.util.List<com.liying.core.bean.DestPoint>> getDoubleInsideGrooveKeyPoint(com.liying.core.bean.KeyInfo r22, com.liying.core.KeyAlignInfo r23) {
        /*
            Method dump skipped, instructions count: 551
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.liying.core.KeyBlankCutStepsGenerateUtil.getDoubleInsideGrooveKeyPoint(com.liying.core.bean.KeyInfo, com.liying.core.KeyAlignInfo):java.util.List");
    }
    ...
    public static ArrayList<Index> getSortSpace(List<List<Integer>> list, final int i) {
        ...
        Collections.sort(arrayList, new Comparator<Index>() { // from class: com.liying.core.KeyBlankCutStepsGenerateUtil.1
