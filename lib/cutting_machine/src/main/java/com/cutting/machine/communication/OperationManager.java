...
import com.liying.core.DataFixUtil;
import com.liying.core.KeyAlignInfo;
import com.liying.core.OperateType;
import com.liying.core.SerialResponse;
import com.liying.core.SpindleState;
...
public class OperationManager extends Observable {
    ...
    private WriteCallback writeCallback = new WriteCallback() { // from class: com.liying.core.communication.OperationManager.1
    ...
    private Runnable checkMsg = new Runnable() { // from class: com.liying.core.communication.OperationManager.3
    ...
    private Runnable writeLogRunnable = new Runnable() { // from class: com.liying.core.communication.OperationManager.7

        /* renamed from: com.liying.core.communication.OperationManager$7$1 */
        /* loaded from: classes2.dex */
        ...
        @Override // java.lang.Runnable
        public void run() {
            new Thread() { // from class: com.liying.core.communication.OperationManager.7.1
    ...
    /* renamed from: com.liying.core.communication.OperationManager$1 */
    /* loaded from: classes2.dex */
    ...
    public void start(String str, OperateType operateType) {
        Log.i(TAG, "start: " + str);
        start(str, (KeyInfo) null, operateType);
    }
    ...
    /* renamed from: com.liying.core.communication.OperationManager$2 */
    /* loaded from: classes2.dex */
    public class C19812 extends Thread {
        ...
        @Override // java.lang.Thread, java.lang.Runnable
        public void run() {
            OperationManager.this.startExecution(AssetsJsonUtils.json2Steps(AssetsJsonUtils.getJsonStringFromAssets(OperationManager.this.context, r2)), r3);
        }
    }
    ...
    */
    private void calculateXYZ(com.liying.core.bean.SerialResBean r36) {
        /*
            Method dump skipped, instructions count: 8306
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.liying.core.communication.OperationManager.calculateXYZ(com.liying.core.bean.SerialResBean):void");
    }

    /* renamed from: com.liying.core.communication.OperationManager$8 */
    /* loaded from: classes2.dex */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: com.liying.core.communication.OperationManager$3 */
    /* loaded from: classes2.dex */
    ...
    private void handleCompleteResponse(byte[] bArr) {
        ...
        if (bArr[1] == Command._bM) {
            if (this.spindleState == SpindleState.ON) {
                this.handler.postDelayed(new Runnable() { // from class: com.liying.core.communication.OperationManager.4
    ...
    /* renamed from: com.liying.core.communication.OperationManager$4 */
    /* loaded from: classes2.dex */
    ...
    private void handleMove(SerialResBean serialResBean) {
        ...
        if (this.f413DC.length() != 0) {
            if (serialResBean.getR() == 1) {
                ...
                this.f413DC.setLength(0);
                try {
                    long pauseTime = getPauseTime() * 1000;
                    if (pauseTime < 0) {
                        pauseTime = 0;
                    }
    ...
    private int[] getDuplicateCutDepth() {
        ...
        Collections.sort(this.zList, new Comparator<PointXyz>() { // from class: com.liying.core.communication.OperationManager.5
        ...
        Collections.sort(arrayList3, new Comparator<List<PointXyz>>() { // from class: com.liying.core.communication.OperationManager.6
    ...
    /* renamed from: com.liying.core.communication.OperationManager$5 */
    /* loaded from: classes2.dex */
    ...
    /* renamed from: com.liying.core.communication.OperationManager$6 */
    /* loaded from: classes2.dex */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: com.liying.core.communication.OperationManager$7 */
    /* loaded from: classes2.dex */
