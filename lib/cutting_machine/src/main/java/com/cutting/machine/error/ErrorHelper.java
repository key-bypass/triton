...
public class ErrorHelper {
    public static void handleError(int i, StepBean stepBean) {
        ...
        ErrorHelper$$ExternalSyntheticLambda0 errorHelper$$ExternalSyntheticLambda0 = new DialogBtnCallBack() { // from class: com.liying.core.error.ErrorHelper$$ExternalSyntheticLambda0
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: com.liying.core.error.ErrorHelper$1 */
    /* loaded from: classes2.dex */
