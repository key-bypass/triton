...
public class StepsGenerateUtil {
    ...
    private static int cutAngle = 90;
    ...
    /* renamed from: com.liying.core.StepsGenerateUtil$3 */
    /* loaded from: classes2.dex */
    ...
    */
    private static java.util.List<com.liying.core.bean.StepBean> getSingleOutGrooveStepBeans(com.liying.core.KeyAlignInfo r11, com.liying.core.bean.KeyAlign r12, int r13, int r14, int r15) {
        /*
            Method dump skipped, instructions count: 364
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.liying.core.StepsGenerateUtil.getSingleOutGrooveStepBeans(com.liying.core.KeyAlignInfo, com.liying.core.bean.KeyAlign, int, int, int):java.util.List");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static java.util.List<com.liying.core.bean.StepBean> getDoubleOutSideGrooveKeyStepBeans(com.liying.core.KeyAlignInfo r11, com.liying.core.bean.KeyAlign r12, int r13, int r14) {
        /*
            Method dump skipped, instructions count: 369
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.liying.core.StepsGenerateUtil.getDoubleOutSideGrooveKeyStepBeans(com.liying.core.KeyAlignInfo, com.liying.core.bean.KeyAlign, int, int):java.util.List");
    }
    ...
    private static List<StepBean> getInsideGrooveKeyStepBeans(KeyAlignInfo keyAlignInfo, int i, List<PointXyz> list, int i2) {
        ...
        while (i7 < list.size()) {
            ...
            sb.append(i12);
            sb.append(",Z");
            arrayList.add(StepBeanFactory.getStepBean(0, 0, 0, 0, speedStr, sb.toString()));
            int i15 = i13 + 1 + 1 + 1 + 1;
            if (CuttingMachine.getInstance().isE9()) {
        ...
        if (list2 != null) {
            ...
            while (i < list.size()) {
                ...
                while (i2 < list3.size()) {
                    ...
                    sb.append("点");
                    int i4 = i2;
                    arrayList.add(new StepBean(sb.toString(), 0, x, y, keyFace, Speed.get_Speed_CuttingIn(), "C:5,X;C:5,Y;C:5,Z;CUTSM", false));
                    if (i4 == list3.size() - 1) {
                        if (i == list.size() - 1) {
    ...
    private static List<StepBean> generateDimpleKeyCutSteps(KeyInfo keyInfo, KeyAlignInfo keyAlignInfo, List<List<CutPoint>> list) {
        ...
        while (i4 < list.size()) {
            ...
            while (i5 < list3.size()) {
                ...
                sb3.append("C:5,X;C:5,Y;C:5,Z;CUTSM;");
                sb3.append(cutPoint.isBreakPoint() ? "BREAK" : "");
                arrayList.add(new StepBean(sb2, 0, x, y, z, str2, sb3.toString(), false));
                if (i == list3.size() - 1) {
    ...
    private static List<StepBean> generateTubularKeyCutSteps(KeyAlignInfo keyAlignInfo, List<List<CutPoint>> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            while (i2 < list2.size()) {
                ...
                sb.append(i3);
                sb.append("点");
                arrayList.add(new StepBean(sb.toString(), 0, x, y, z, Speed.get_Speed_CuttingIn(), "C:5,X;C:5,Y;C:5,Z;CUTSM", false));
                if (i2 == list2.size() - 1) {
                    arrayList.add(new StepBean(0, x, y, keyFace, Speed.get_Speed_SpindleTurnOff_Move(), "C:5,X;C:5,Y;C:5,Z;", false));
                }
                i2 = i3;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static java.util.List<com.liying.core.bean.StepBean> singleOutSideGrooveTip2ShoulderPath(com.liying.core.bean.KeyInfo r36, com.liying.core.KeyAlignInfo r37, java.util.List<java.util.List<com.liying.core.CutPoint>> r38) {
        /*
            Method dump skipped, instructions count: 596
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.liying.core.StepsGenerateUtil.singleOutSideGrooveTip2ShoulderPath(com.liying.core.bean.KeyInfo, com.liying.core.KeyAlignInfo, java.util.List):java.util.List");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static java.util.List<com.liying.core.bean.StepBean> generateDoubleSideKeyCutSteps(com.liying.core.bean.KeyInfo r45, com.liying.core.KeyAlignInfo r46, java.util.List<java.util.List<com.liying.core.CutPoint>> r47, java.util.List<java.util.List<com.liying.core.CutPoint>> r48, boolean r49) {
        /*
            Method dump skipped, instructions count: 1497
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.liying.core.StepsGenerateUtil.generateDoubleSideKeyCutSteps(com.liying.core.bean.KeyInfo, com.liying.core.KeyAlignInfo, java.util.List, java.util.List, boolean):java.util.List");
    }
        ...
        while (i5 < 1) {
            ...
            while (i6 < size) {
                ...
                while (true) {
                    ...
                    sb2.append(i82);
                    sb2.append(str4);
                    arrayList.add(new StepBean(sb2.toString(), 0, x, y, keyFace, Speed.get_Speed_CuttingIn(), "C:5,X;C:5,Y;C:5,Z;CUTSM", false));
                    i7 = i82;
                    i6 = i3;
                    list7 = list4;
                    list6 = list5;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static int[] getDuplicateCutCountAndMaxDepth(com.liying.core.bean.KeyInfo r11, com.liying.core.KeyAlignInfo r12, java.util.List<com.liying.core.bean.DestPoint> r13, int r14) {
        /*
            int r0 = r11.getType()
            r1 = 2
            if (r0 != r1) goto Ld
        ...
        L13:
            ...
            com.liying.core.bean.DestPoint r5 = (com.liying.core.bean.DestPoint) r5
            int r7 = r5.getSpace()
            int r7 = r7 - r14
        ...
        L38:
            ...
            float r9 = com.liying.core.clamp.MachineData.dYScale
            float r8 = r8 / r9
            float r7 = r7 + r8
        ...
        L96:
            ...
            int r2 = com.liying.core.ToolSizeManager.getCutterSize2()
            double r7 = (double) r2
        ...
        Lca:
            ...
            return r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.liying.core.StepsGenerateUtil.getDuplicateCutCountAndMaxDepth(com.liying.core.bean.KeyInfo, com.liying.core.KeyAlignInfo, java.util.List, int):int[]");
    }
    ...
    private static void fixSingleInsideGrooveData(KeyAlignInfo keyAlignInfo, KeyAlignInfo keyAlignInfo2, List<DestPoint> list, List<DestPoint> list2) {
        ...
        Collections.sort(list, new Comparator<DestPoint>() { // from class: com.liying.core.StepsGenerateUtil.1
            @Override // java.util.Comparator
            public int compare(DestPoint destPoint9, DestPoint destPoint10) {
                return destPoint10.getSpace() - destPoint9.getSpace();
            }
        });
        Collections.sort(list2, new Comparator<DestPoint>() { // from class: com.liying.core.StepsGenerateUtil.2
            @Override // java.util.Comparator
            public int compare(DestPoint destPoint9, DestPoint destPoint10) {
                return destPoint10.getSpace() - destPoint9.getSpace();
            }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static java.util.List<java.util.List<com.liying.core.CutPoint>> generateDuplicateMultiCutPath(com.liying.core.bean.KeyInfo r22, com.liying.core.KeyAlignInfo r23, com.liying.core.KeyAlignInfo r24, java.util.List<com.liying.core.bean.DestPoint> r25, int[] r26, boolean r27) {
        /*
            Method dump skipped, instructions count: 1095
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.liying.core.StepsGenerateUtil.generateDuplicateMultiCutPath(com.liying.core.bean.KeyInfo, com.liying.core.KeyAlignInfo, com.liying.core.KeyAlignInfo, java.util.List, int[], boolean):java.util.List");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static java.util.List<java.util.List<com.liying.core.CutPoint>> generateKeyBlankMultiCutPath(com.liying.core.bean.KeyInfo r21, com.liying.core.KeyAlignInfo r22, java.util.List<com.liying.core.bean.DestPoint> r23, int r24, boolean r25) {
        /*
            Method dump skipped, instructions count: 901
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.liying.core.StepsGenerateUtil.generateKeyBlankMultiCutPath(com.liying.core.bean.KeyInfo, com.liying.core.KeyAlignInfo, java.util.List, int, boolean):java.util.List");
    }
