...
public class KeyInfo implements Parcelable, KeyInfoBase {
    ...
    public static final Parcelable.Creator<KeyInfo> CREATOR = new Parcelable.Creator<KeyInfo>() { // from class: com.liying.core.bean.KeyInfo.1
    ...
    public void readFromParcel(Parcel parcel) {
        this.clampBean = (ClampBean) parcel.readParcelable(ClampBean.class.getClassLoader());
