...
import com.liying.core.StepBeanTypeAdapter;
import com.liying.core.bean.CalibrationBean;
...
public class AssetsJsonUtils {
    ...
    public static List<StepBean> json2Steps(String str) {
        return ((CalibrationBean) new GsonBuilder().registerTypeAdapter(StepBean.class, new StepBeanTypeAdapter()).create().fromJson(str, CalibrationBean.class)).getStepBeanList();
    }
    ...
    /* renamed from: com.liying.core.utils.AssetsJsonUtils$1 */
    /* loaded from: classes2.dex */
