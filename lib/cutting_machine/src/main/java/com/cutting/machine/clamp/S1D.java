...
public class S1D extends ClampF {
    ...
    public S1D(List<SerialResBean> list) {
    ...
    public String toString() {
        return "S1D{shoulderDiff=" + this.shoulderDiff + ", rightDiff=" + this.rightDiff + ", leftDiff=" + this.leftDiff + '}';
    }

    @Override // com.liying.core.clamp.ClampF
    public byte[] getCommand() {
        return Command.WriteSpecifyLocationData(68, getShoulderDiff() + ":" + getRightDiff() + ":" + getLeftDiff());
    }
}
