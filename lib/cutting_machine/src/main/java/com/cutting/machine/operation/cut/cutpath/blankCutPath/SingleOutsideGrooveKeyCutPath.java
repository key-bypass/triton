    ...
    private List<StepBean> sideACutSteps(List<List<KeyPoint>> list) {
        ...
        while (i4 < size) {
            ...
            while (i5 < list3.size()) {
                ...
                sb.append(i7);
                sb.append("点");
                arrayList.add(StepBeanFactory.getCutStepBean(sb.toString(), i6, yKey2Machine2, cutZ, Speed.get_Speed_CuttingIn(), "C:5,X;C:5,Y;C:5,Z;CUTSM;"));
                if (i == list2.size() - 1) {
    ...
    */
    protected int[] splitCut(int r10) {
        ...
        L16:
            ...
            r5 = 2
            if (r0 != r5) goto L24
            float[] r5 = com.liying.core.operation.cut.cutpath.blankCutPath.SingleOutsideGrooveKeyCutPath.twiceCut
            r5 = r5[r3]
        L1f:
            float r5 = r5 * r2
        L21:
        ...
        L24:
            r5 = 3
            if (r0 != r5) goto L2c
            float[] r5 = com.liying.core.operation.cut.cutpath.blankCutPath.SingleOutsideGrooveKeyCutPath.thriceCut
            r5 = r5[r3]
            goto L1f
        L2c:
            r5 = 4
            if (r0 != r5) goto L34
            float[] r5 = com.liying.core.operation.cut.cutpath.blankCutPath.SingleOutsideGrooveKeyCutPath.fourCut
            r5 = r5[r3]
            goto L1f
        L34:
            int r5 = r0 + (-1)
        ...
        L65:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.liying.core.operation.cut.cutpath.blankCutPath.SingleOutsideGrooveKeyCutPath.splitCut(int):int[]");
    }
