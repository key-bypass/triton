...
import com.cutting.machine.utils.FileUtil;
...
public class ClampManager {
    ...
    private final String S1A_json = "S1-A.json";
    private final String E9_S1A_json = "E9_S1-A.json";
    private final String S1B_json = "S1-B.json";
    private final String S1C_json = "S1-C.json";
    private final String E9_S1C_json = "E9_S1-C.json";
    private final String S1D_json = "S1-D.json";
    private final String S2A_json = "S2-A.json";
    private final String E9_S2A_json = "E9_S2-A.json";
    private final String S2B_json = "S2-B.json";
    private final String E9_S2B_json = "E9_S2-B.json";
    private final String S3_json = "S3.json";
    private final String S4_json = "S4.json";
    private final String S5_json = "S5.json";
    private final String S8_json = "S8.json";
    private final String dc_json = "D-C.json";
    private final String clampFixFile = "clampFix";
    ClampF clampF;
    ClampFix clampFix;
    /* renamed from: dc */
    ...
    private S5 string2S5(String str) {
        if (TextUtils.isEmpty(str)) {
            return null;
        }
        String[] split = str.split(":");
        ...
        S5 s5 = new S5();
        s5.setX(Integer.parseInt(split[0]));
        s5.setY(Integer.parseInt(split[1]));
        s5.setDeep(Integer.parseInt(split[2]));
        return s5;
    }
    ...
    public void setS8(S8 s8) {
        this.f403s8 = s8;
    }

    private S8 string2S8(String str) {
        if (TextUtils.isEmpty(str)) {
            return null;
        }
        String[] split = str.split(":");
        ...
        S8 s8 = new S8();
        s8.setLength(Integer.parseInt(split[0]));
        s8.setHeight1(Integer.parseInt(split[1]));
        s8.setHeight2(Integer.parseInt(split[2]));
        return s8;
    }
    ...
    public boolean checkHaveRiskCutClamp(KeyAlignInfo keyAlignInfo, int i, int i2, int i3, int i4) {
        ...
        switch (this.clamp) {
            ...
            case S2_B:
                ...
                return false;
            case S3:
                new S3().haveRiskCutClamp(keyAlignInfo, i, i2, i3);
                return false;
            case S4:
            default:
                return false;
