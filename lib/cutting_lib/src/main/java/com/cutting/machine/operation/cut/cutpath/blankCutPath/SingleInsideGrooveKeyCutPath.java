...
public class SingleInsideGrooveKeyCutPath extends KeyBlankCutPath {
    ...
    */
    public java.util.List<com.cutting.machine.bean.StepBean> getCutPathSteps() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.cutting.machine.operation.cut.cutpath.blankCutPath.SingleInsideGrooveKeyCutPath.getCutPathSteps():java.util.List");
    }
                ...
                while (true) {
                    ...
                    if (i5 < i6) {
                        ...
                        while (i8 < list4.size()) {
                            ...
                            int i10 = i8;
                            String str6 = str4;
                            arrayList.add(StepBeanFactory.getCutStepBean(sb, keyX2MachineValue2, KeyY2MachineValue2, i4, Speed.get_Speed_CuttingIn(), "C:5,X;C:5,Y;C:5,Z;CUTSM;"));
                            if (i10 == list4.size() - 1) {
