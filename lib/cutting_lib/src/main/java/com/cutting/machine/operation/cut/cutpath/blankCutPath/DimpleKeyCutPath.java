...
public class DimpleKeyCutPath extends KeyBlankCutPath {
    ...
    */
    public java.util.List<com.cutting.machine.bean.StepBean> getCutPathSteps() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.cutting.machine.operation.cut.cutpath.blankCutPath.DimpleKeyCutPath.getCutPathSteps():java.util.List");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private java.util.List<com.cutting.machine.bean.StepBean> generateKeyCutSteps(java.util.List<java.util.List<com.cutting.machine.operation.cut.cutpath.KeyPoint>> r26) {
        /*
            Method dump skipped, instructions count: 509
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.cutting.machine.operation.cut.cutpath.blankCutPath.DimpleKeyCutPath.generateKeyCutSteps(java.util.List):java.util.List");
    }
