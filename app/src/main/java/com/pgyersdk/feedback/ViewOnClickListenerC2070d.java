...
import com.pgyersdk.feedback.p017a.C2054e;
...
import com.pgyersdk.p016f.C2040e;
...
public class ViewOnClickListenerC2070d extends RelativeLayout implements View.OnClickListener {
    ...
    private void m331b(Context context) {
        ...
        this.f666z.setMargins(C2037b.m195a(context, 40.0f), 0, C2037b.m195a(context, 40.0f), 0);
        ...
        this.f666z.height = (this.f658r - this.f655o.getMeasuredHeight()) - C2037b.m195a(context, 70.0f);
        ...
        int m195a = C2037b.m195a(context, 30.0f);
        int m195a2 = C2037b.m195a(context, 120.0f) + (m195a * 6);
        ...
        relativeLayoutParams.height = C2037b.m195a(context, 45.0f);
        relativeLayoutParams.setMargins(C2037b.m195a(context, 5.0f), 0, 0, 0);
        ...
        defaultLayoutParams2.height = C2037b.m195a(context, 45.0f);
        ...
        if (Build.VERSION.SDK_INT >= 11) {
            ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this.f648h, "translationY", 0.0f, -(defaultLayoutParams2.height + C2037b.m195a(context, 2.0f)));
            this.f659s = ofFloat;
            ofFloat.setDuration(300L);
            ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(this.f648h, "translationY", -(defaultLayoutParams2.height + C2037b.m195a(context, 2.0f)), 0.0f);
            this.f660t = ofFloat2;
            ofFloat2.setDuration(300L);
            return;
        }
        TranslateAnimation translateAnimation = new TranslateAnimation(0.0f, 0.0f, 0.0f, -C2037b.m195a(context, 45.0f));
        this.f661u = translateAnimation;
        translateAnimation.setDuration(300L);
        this.f661u.setFillAfter(true);
        this.f661u.setFillEnabled(true);
        TranslateAnimation translateAnimation2 = new TranslateAnimation(0.0f, 0.0f, C2037b.m195a(context, 45.0f), 0.0f);
    ...
    private View m333d(Context context) {
        ...
        textView.setText(C2023b.m151a(1062));
    ...
    public void onClick(View view) {
        ...
        if (view.equals(this.f653m)) {
            f644e = C2038c.m196a().m206e(this.f656p);
            C2040e.m215a(this.f647g.m263c(), f644e);
            String m222a = C2043h.m222a(getContext(), "selfmail");
            String m222a2 = C2043h.m222a(getContext(), "feedback_des");
            File file = C2046k.m235a(C2043h.m222a(getContext(), "voicefile")) ? null : new File(C2043h.m222a(getContext(), "voicefile"));
            if (C2046k.m235a(m222a)) {
                m325a();
                Toast.makeText(PgyerProvider.f436a, C2023b.m151a(1063), 0).show();
            } else if (!C2048m.m248a(m222a)) {
                m325a();
    ...
    private View m322a(Context context) {
        ...
        LinearLayout.LayoutParams defaultLayoutParams2 = getDefaultLayoutParams();
        defaultLayoutParams2.setMargins(0, -C2037b.m195a(context, 10.0f), 0, 0);
        defaultLayoutParams2.gravity = 1;
        defaultLayoutParams2.height = C2037b.m195a(context, 4.0f);
        defaultLayoutParams2.width = C2037b.m195a(context, 20.0f);
        ...
        C2050a c2050a2 = new C2050a(context);
        this.f650j = c2050a2;
        c2050a2.setImageBitmap(C2040e.m213a(C2040e.m214a(C2022a.f477o), C2037b.m195a(context, 40.0f), C2037b.m195a(context, 40.0f)));
    ...
    private C2054e m324a(Context context, int i) {
        ...
        this.f648h.setPadding(0, 0, 0, C2037b.m195a(context, 5.0f));
        LinearLayout.LayoutParams defaultLayoutParams1 = getDefaultLayoutParams1();
        defaultLayoutParams1.setMargins(C2037b.m195a(context, 10.0f), 0, C2037b.m195a(context, 10.0f), 0);
        defaultLayoutParams1.gravity = 16;
        defaultLayoutParams1.height = C2037b.m195a(context, 30.0f);
    ...
    private View m323a(Context context, a aVar, int i, Paint paint) {
        ...
        defaultFrameLayoutParams.width = C2037b.m195a(context, 10.0f);
