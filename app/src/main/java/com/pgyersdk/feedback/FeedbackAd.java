...
public class FeedbackAd extends Shape {
    ...
    final ViewOnClickListenerC2070d f551d;

    public FeedbackAd(ViewOnClickListenerC2070d viewOnClickListenerC2070d, Paint paint, Context context, int i) {
