...
public class C2086e implements DownloadFileListener {
    ...
    private Dialog m381b() {
        ...
        builder.setNegativeButton(Strings.m151a(258), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                m382a();
            }
        });
        builder.setPositiveButton(Strings.m151a(259), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
