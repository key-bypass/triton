...
import com.kkkcut.zip4j.crypto.PBKDF2.BinTools;
...
public class C2022a {
    ...
    private static void m147e(Context context) {
        ...
        if (f465c == null || string == null) {
            return;
        }
        String str = f465c + ":" + string + ":" + m146d(context);
        try {
    ...
    private static void m148f(Context context) {
        if (context != null) {
            try {
                ...
                C2041f.m218b("PgyerSDK", "Exception thrown then accessing the device info:");
                e.printStackTrace();
            }
        }
    }
    ...
    private static void m149g(Context context) {
        if (context != null) {
            try {
                ...
                C2041f.m218b("PgyerSDK", "Exception thrown when accessing the files dir:");
                e.printStackTrace();
            }
        }
    }
    ...
    private static void m150h(Context context) {
        if (context != null) {
            try {
                ...
                C2041f.m218b("PgyerSDK", "Exception thrown when accessing the package info:");
                e.printStackTrace();
            }
        }
    }
    ...
    */
    ...
    private static int m140a(Context context, PackageManager packageManager) {
        try {
            ...
            C2041f.m218b("PgyerSDK", "Exception thrown when accessing the application info:");
            e.printStackTrace();
        }
        return 0;
    }
