...
public class C2001a {
    ...
    public static Map<String, String> m101b() {
        ...
        hashMap.put("agKey", C2022a.f474l);
        hashMap.put("deviceId", C2022a.f471i);
        hashMap.put("osType", "2");
        hashMap.put("from", C2022a.f468f);
        hashMap.put("deviceName", C2022a.f469g);
        hashMap.put("osVersion", C2022a.f467e);
        hashMap.put("sdkVersion", C2022a.f473k);
        hashMap.put("_api_key", "305092bc73c180b55c26012a94809131");
        hashMap.put("versionCode", C2022a.f464b);
        hashMap.put("version", C2022a.f466d);
        hashMap.put("deviceModel", C2022a.f468f);
        hashMap.put("resolution", C2022a.f472j);
        hashMap.put("jailBroken", C2022a.m143a() ? "1" : "2");
        String[] m168a = C2033a.m168a();
        hashMap.put("freeSapce", m168a[1] + " / " + m168a[0]);
        if (C2033a.m172c()) {
            String[] m170b = C2033a.m170b();
            hashMap.put("freeSdc", m170b[1] + " / " + m170b[0]);
        }
        String[] m174e = C2033a.m174e(PgyerProvider.f436a);
        if (m174e.length == 2) {
            str = m174e[1] + " / " + m174e[0];
        } else {
            str = "";
        ...
        hashMap.put("battery", C2033a.m166a(PgyerProvider.f436a));
        hashMap.put("protrait", PgyerProvider.f436a.getResources().getConfiguration().orientation + "");
        Map<String, String> m173d = C2033a.m173d(PgyerProvider.f436a);
    ...
    public static class a extends AsyncTask<Void, Void, HashMap<String, String>> {
        ...
        */
        ...
        public void onPostExecute(HashMap<String, String> hashMap) {
            ...
            C2033a.m176h(PgyerProvider.f436a);
        }
    }
}
