...
public class HttpURLConnectionBuilder {
    ...
    /* renamed from: d */
    private SimpleMultipartEntity f529d;
    ...
    /* renamed from: a */
    public HttpURLConnectionBuilder m207a(String str) {
        this.f527b = str;
        return this;
    }

    /* renamed from: a */
    public HttpURLConnectionBuilder m209a(Map<String, String> map, Context context, File file, List<Uri> list) {
        try {
            SimpleMultipartEntity simpleMultipartEntity = new SimpleMultipartEntity();
            this.f529d = simpleMultipartEntity;
            simpleMultipartEntity.m231d();
    ...
    /* renamed from: a */
    public HttpURLConnectionBuilder m208a(String str, String str2) {
    ...
    public HttpURLConnection m210a() {
        try {
            ...
            SimpleMultipartEntity simpleMultipartEntity = this.f529d;
            if (simpleMultipartEntity != null) {
                httpURLConnection.setRequestProperty("Content-Length", String.valueOf(simpleMultipartEntity.m229b()));
