...
import com.pgyersdk.p016f.C2039d;
...
public class AsyncTaskC2031f extends AsyncTask<Void, Void, Object> {
    ...
    public AsyncTaskC2031f() {
        this.f493c = false;
    }

    /* renamed from: b */
    private Boolean m159b(StringBuffer stringBuffer, boolean z) throws IOException {
        Map<String, String> m101b = C2001a.m101b();
        m101b.put("crashLog", stringBuffer.toString());
        m101b.put("isException", z ? "2" : "1");
        HttpURLConnection m210a = new C2039d("http://www.pgyer.com/apiv1/crash/add").m207a("POST").m209a(m101b, PgyerProvider.f436a, null, null).m210a();
        this.f491a = m210a;
    ...
    public AsyncTaskC2031f(StringBuffer stringBuffer, boolean z) {
    ...
    private void m158a() {
        File[] listFiles;
        if (C2047l.m244e() && C2048m.m249b()) {
            File file = new File(C2038c.m196a().m202b(PgyerProvider.f436a));
            if (file.exists() && file.isDirectory() && (listFiles = file.listFiles()) != null) {
                for (int i = 0; i < listFiles.length; i++) {
                    StringBuffer stringBuffer = new StringBuffer();
                    try {
                        C2048m.m247a(stringBuffer, listFiles[i].getPath());
