...
public class EngraveE9PathGen {
    ...
    public static List<StepBean> bitmapToPath(Bitmap bitmap, EngraveParam engraveParam) {
        ...
        while (true) {
            ...
            if (i5 >= i6) {
                ...
                arrayList.add(1, new StepBean(0, 0, 0, 0, "", "U:X;U:Y;U:Z;SUP:1,8000"));
                arrayList.add(new StepBean(0, 0, 0, 0, "", "U:X;U:Y;U:Z;SUP:0,0"));
    ...
    public static List<StepBean> detectCutterHigh(Bitmap bitmap, EngraveParam engraveParam) {
        ...
        arrayList.add(new StepBean("移动到切割区域中点", 0, (int) (engraveParam.getClampOriginX() + ((height + engraveParam.getPictureOriginY()) / MachineData.dXScale) + engraveParam.getDcX()), (int) (engraveParam.getClampOriginY() + ((width + engraveParam.getPictureOriginX()) / MachineData.dYScale) + engraveParam.getDcY()), 0, "8000,8000,3000", "C:5,X;C:5,Y;", false));
        arrayList.add(new StepBean("探测钥匙表面", 1, 0, 0, 4500, "4000,4000,3000", "U:Z;"));
        arrayList.add(new StepBean("离开钥匙表面", 0, 0, 0, -100, "8000,8000,3000", "U:Z;C:3,K,Z-2"));
        return arrayList;
    }
    ...
    private static void addCutPoint(List<StepBean> list, int i, int i2, EngraveParam engraveParam, boolean z) {
        ...
        int pictureOriginY = (int) (clampOriginX + (((i2 * 10) + engraveParam.getPictureOriginY()) / MachineData.dXScale) + dcX);
        int pictureOriginX = (int) (clampOriginY + (((i * 10) + engraveParam.getPictureOriginX()) / MachineData.dYScale) + dcY);
        int keyFaceZ = engraveParam.getKeyFaceZ();
        if (z) {
            stepBean = new StepBean("切割", 0, pictureOriginY, pictureOriginX, keyFaceZ + engraveParam.getCutDepth(), Speed.get_Speed_Engrave(), "C:5,X;C:5,Y;C:5,Z;CUTSM", false);
        } else {
            stepBean = new StepBean("空走", 0, pictureOriginY, pictureOriginX, (int) (keyFaceZ - (20.0f / MachineData.dZScale)), Speed.get_Speed_Engrave(), "C:5,X;C:5,Y;C:5,Z;CUTSM", false);
        }
        list.add(stepBean);
    }
