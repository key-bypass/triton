...
public class KeyMarkingE9Layout extends FrameLayout {
    ...
    public KeyMarkingE9Layout(Context context) {
        this(context, null);
    }

    public KeyMarkingE9Layout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public KeyMarkingE9Layout(Context context, AttributeSet attributeSet, int i) {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.markLineVisible) {
            ...
            canvas.drawLine(45.0f, 45.0f, 45.0f, getMeasuredHeight(), this.paint);
            canvas.drawLine(45.0f, 45.0f, getMeasuredWidth(), 45.0f, this.paint);
            ...
            for (int i = 0; i < 7; i++) {
                int i2 = i / 2;
                if (i % 2 != 0) {
                    float f3 = (i2 * 100) + 95.0f;
                    canvas.drawText(String.valueOf(Math.abs(i2 - 1)), f3, f2, this.paint);
            ...
            for (int i3 = 0; i3 < 7; i3++) {
                ...
                if (i3 % 2 != 0) {
                    float f5 = (i4 * 100) + 95;
                    canvas.drawLine(40.0f, f5, 45.0f, f5, this.paint);
                    this.paint.setPathEffect(new DashPathEffect(new float[]{4.0f, 8.0f}, 0.0f));
                    this.paint.setColor(this.color_4b4d62);
                    ...
                    float f6 = (i4 * 100) + 45;
                    canvas.drawText(String.valueOf(i4), 22.5f, f6 + f, this.paint);
                    canvas.drawLine(35.0f, f6, 45.0f, f6, this.paint);
                    this.paint.setPathEffect(new DashPathEffect(new float[]{4.0f, 8.0f}, 0.0f));
                    this.paint.setColor(this.color_4b4d62);
            ...
            int i5 = this.rightBorder;
            canvas.drawRect(195 - (i5 / 2), 55.0f, (i5 / 2) + HSSFShapeTypes.ActionButtonEnd, getHeight() - 10, this.paint);
        }
    }
}
