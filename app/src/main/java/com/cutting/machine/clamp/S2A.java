...
public class S2A extends ClampF {
    private int deep;
    ...
    public S2A(List<SerialResBean> list) {
    ...
    public int getX() {
        return (this.f408x2 + this.f407x1) / 2;
    }

    @Override // com.cutting.machine.clamp.ClampF
    public byte[] getCommand() {
        return Command.WriteSpecifyLocationData(1, getShoulderDiff() + ":" + getDeep() + ":" + getX1() + ":" + getX2());
    }
}
