...
import com.cutting.machine.duplicate.keyview.Line;
import com.cutting.machine.duplicate.keyview.LineUtils;
...
public class DuplicateInsideGrooveKeyCut extends DuplicateCutPath {
            ...
            while (true) {
                if (i2 < destPointList.size() - 1) {
                    ...
                    if (destPoint.isInvalid()) {
                        ...
                        int r3 = destPoint.getSpace();
                        if (destPoint.getSpace() > r3 + ((int) ((cutLength - r3) * 0.5d))) {
                            return true;
                        }
                    }
                }
                ...
                while (i11 < i) {
                    ...
                    while (i28 < destPointList2.size()) {
                        ...
                        String sb = "右边第" +
                                ...
                                i29 +
                                str6;
                        arrayList.add(StepBeanFactory.getCutStepBean(sb, keyX2MachineValue2, KeyY2MachineValueBaseRight, i20, Speed.get_Speed_CuttingOut(), "C:5,X;C:5,Y;C:5,Z;CUTSM;"));
        ...
        for (int i3 = 0; i3 < maxCutCount; i3++) {
            if (i3 >= i) {
                ...
                while (i4 < list2.size()) {
                    ...
                    boolean z2 = destPoint2.isSharpenPoint() || z;
                    if (z2) {
                        int space2 = destPoint2.getSpace();
    ...
    private void fixSingleInsideGrooveData() {
        ...
        for (int i4 = 0; i4 < pathDataList.size() - 1; i4 += 2) {
            ...
            Collections.sort(destPointList, new Comparator<DestPoint>() { // from class: com.cutting.machine.operation.duplicateCut.cutpath.DuplicateInsideGrooveKeyCut.1
                @Override // java.util.Comparator
                public int compare(DestPoint destPoint15, DestPoint destPoint16) {
                    return destPoint15.getSpace() - destPoint16.getSpace();
                }
            });
            Collections.sort(destPointList2, new Comparator<DestPoint>() { // from class: com.cutting.machine.operation.duplicateCut.cutpath.DuplicateInsideGrooveKeyCut.2
                @Override // java.util.Comparator
                public int compare(DestPoint destPoint15, DestPoint destPoint16) {
                    return destPoint15.getSpace() - destPoint16.getSpace();
                }
