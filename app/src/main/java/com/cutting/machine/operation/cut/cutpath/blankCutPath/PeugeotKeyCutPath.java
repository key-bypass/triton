            ...
            for (int i7 = 0; i7 < list3.size(); i7++) {
                ...
                while (i8 < cutCount()) {
                    if (i6 == 0) {
                        ...
                        list = (List<KeyPoint>) arrayList2.get(i8);
                    }
            ...
            while (i5 < getLayer()) {
                ...
                while (i7 < size) {
                    ...
                    while (i10 < list5.size()) {
                        ...
                        String str6 = str4;
                        arrayList.add(StepBeanFactory.getCutStepBean(sb, keyX2MachineValue2, KeyY2MachineValueBaseRight, i6, Speed.get_Speed_CuttingOut(), "C:5,X;C:5,Y;C:5,Z;CUTSM;"));
                        if (i12 == list6.size() - 1) {
