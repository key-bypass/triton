...
public class KeyData {
    ...
    private final KeyAlign align;
    private final String cutSharpenType;
    private final KeyInfo keyInfo;
    private KeyType keyType;
    private final List<List<Integer>> realDepthList;
    private final List<List<Integer>> spaceList;
    private final List<List<Integer>> spaceWidthList;
