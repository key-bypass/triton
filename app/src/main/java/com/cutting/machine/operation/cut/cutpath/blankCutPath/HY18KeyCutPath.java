        ...
        for (int i3 = 0; i3 < keyPointsGroup.size(); i3++) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                ...
                for (int i5 = 0; i5 < cutCount(); i5++) {
                    list = (List<KeyPoint>) arrayList.get(i5);
    ...
    */
    protected int[] splitCut(int r11) {
        ...
        L19:
            ...
            r6 = 2
            if (r0 != r6) goto L27
            float[] r6 = com.cutting.machine.operation.cut.cutpath.blankCutPath.HY18KeyCutPath.twiceCut
            r6 = r6[r4]
        L22:
            float r6 = r6 * r3
        L24:
        ...
        L27:
            r6 = 3
            if (r0 != r6) goto L2f
            float[] r6 = com.cutting.machine.operation.cut.cutpath.blankCutPath.HY18KeyCutPath.thriceCut
            r6 = r6[r4]
            goto L22
        L2f:
            r6 = 4
            if (r0 != r6) goto L37
            float[] r6 = com.cutting.machine.operation.cut.cutpath.blankCutPath.HY18KeyCutPath.fourCut
            r6 = r6[r4]
            goto L22
        L37:
            int r6 = r0 + (-1)
        ...
        L62:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.cutting.machine.operation.cut.cutpath.blankCutPath.HY18KeyCutPath.splitCut(int):int[]");
    }
