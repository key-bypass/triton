package com.cutting.machine.operation.cut.cutpath.blankCutPath.base;
...
import com.cutting.machine.operation.cut.cutpath.KeyData;
...
public abstract class KeyBlankCutPath {
    ...
    private final KeyAlignInfo keyAlignInfo;
    private final KeyData keyData;
    private final List<List<KeyPoint>> keyPointsGroup = initKeyPoint();
    ...
    */
    private java.util.List<java.util.List<com.cutting.machine.operation.cut.cutpath.KeyPoint>> initKeyPoint() {
        /*
            Method dump skipped, instructions count: 955
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.cutting.machine.operation.cut.cutpath.blankCutPath.base.KeyBlankCutPath.initKeyPoint():java.util.List");
    }
    ...
    public ArrayList<Index> getPeugeoKeySortSpace() {
        ...
        Collections.sort(arrayList, new Comparator<Index>() { // from class: com.cutting.machine.operation.cut.cutpath.blankCutPath.base.KeyBlankCutPath.1
